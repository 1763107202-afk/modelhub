...
function renderChrome(){
  q("#siteHeader").innerHTML='<header class="siteHeader"><div class="wrap headerInner"><a class="brand" href="./index.html"><img src="./assets/lab-logo.webp?v=14" alt="实验室标志"><span class="brandText"><b>江苏科技大学机械创新实验室交流平台</b><small>实验室交流 · 学习资料 · 项目协作</small></span></a><nav class="nav">'+
  ...
  q("#siteFooter").innerHTML='<footer class="foot"><div class="wrap footInner"><img src="./assets/lab-logo.webp?v=14" alt="实验室标志"><div><b>江苏科技大学机械创新实验室交流平台</b><small>实验室交流 · 学习资料 · 项目协作</small></div></div></footer>';
