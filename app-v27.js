...
async function initTutorials(){
  ...
  render();
  if(!globalThis.__tutorialsRealtime){
    globalThis.__tutorialsRealtime=supabase.channel("tutorials-live-refresh")
      .on("postgres_changes",{event:"*",schema:"public",table:"tutorials"},()=>initTutorials())
      .subscribe();
  }
}
