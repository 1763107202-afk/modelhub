...
function embed(u){
  ...
  const b=u.match(/bilibili\.com\/video\/(BV[\w]+)/i);if(b)return '<iframe src="https://player.bilibili.com/player.html?bvid='+esc(b[1])+'&page=1&high_quality=1" allowfullscreen scrolling="no"></iframe>';
