...
async function initProgress(){
  ...
  if(form)form.onsubmit=async e=>{
    ...
    try{
      ...
      const ins=await supabase.from("progress_updates").insert({
      ...
      form.reset();q("#progressFilePreview").textContent="";toast("个人进度提交成功");await loadProgressPage();
  ...
  if(teamForm)teamForm.onsubmit=async e=>{
    ...
    try{
      ...
      if(btn){btn.disabled=true;btn.textContent="正在提交…"}
      const rr=await supabase.rpc("create_team_progress",{
