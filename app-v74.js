...
function renderChrome(){
  const globalSearchMarkup=page==="home"
    ...
    : '';
  q("#siteHeader").innerHTML='<header class="siteHeader '+(page==="home"?"homeSearchHeader":"")+'"><div class="wrap headerInner"><a class="brand" href="./index.html"><img src="./assets/lab-logo-transparent.svg?v=3" alt="实验室标志"><span class="brandText"><b>江苏科技大学机械创新实验室</b><small>交流平台 · 学习资料 · 项目协作</small></span></a>'+globalSearchMarkup+'<nav class="nav">'+
  ...
  q("#siteFooter").innerHTML='<footer class="foot"><div class="wrap footInner"><img src="./assets/lab-logo-transparent.svg?v=3" alt="实验室标志"><div><b>江苏科技大学机械创新实验室</b><small>交流平台 · 学习资料 · 项目协作</small></div></div></footer>';
